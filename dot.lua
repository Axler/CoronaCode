...
local value="100" -- Strings are evaluated as they are in Ceramic Tile Engine

t=dot(t, keyString, value)
print(t.stuff.items.weapons.laserGun.ammo) --> 100

Originally for Ceramic Tile Engine
www.github.com/superqix/Ceramic-Tile-Engine
www.gymbyl.com
--]]
